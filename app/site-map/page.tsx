    ...
    pages: [
      {
        ...
        description: 'Virtual primary care across Washington',
      },
      {
        title: 'Seattle',
        href: '/locations/washington/seattle',
        description: 'Concierge medicine for Seattle residents',
      },
      {
        title: 'Bellevue',
        href: '/locations/washington/bellevue',
        description: 'Virtual primary care in Bellevue',
      },
      {
        title: 'Spokane',
        href: '/locations/washington/spokane',
        description: 'Serving Spokane with virtual care',
      },
      {
        title: 'Kirkland',
        href: '/locations/washington/kirkland',
        description: 'Primary care for Kirkland residents',
      },
      {
        title: 'Redmond',
        href: '/locations/washington/redmond',
        description: 'Concierge medicine in Redmond',
      },
      {
        title: 'Sammamish',
        href: '/locations/washington/sammamish',
        description: 'Virtual care for Sammamish families',
      },
      {
        title: 'Mercer Island',
        href: '/locations/washington/mercer-island',
        description: 'Primary care on Mercer Island',
      },
      {
        title: 'Tacoma',
        href: '/locations/washington/tacoma',
        description: 'Virtual medicine in Tacoma',
      },
      {
        title: 'Everett',
        href: '/locations/washington/everett',
        description: 'Serving Everett with concierge care',
      },
      {
        title: 'Olympia',
        href: '/locations/washington/olympia',
        description: 'Primary care for Olympia residents',
      },
      {
        title: 'Vancouver',
        href: '/locations/washington/vancouver',
        description: 'Virtual care in Vancouver, WA',
      },
    ],
  },
  {
