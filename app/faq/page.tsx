      ...
      items: [
        {
          ...
          answer: (
            <div className="space-y-3">
              <p>Sankofa Family Medicine is a membership-based primary care practice. We do not bill insurance companies for membership fees or primary care services.</p>
              <p>This membership model allows us to:</p>
              ...
              <p>You may use insurance for labs, imaging, prescriptions, and specialist referrals outside of your membership.</p>
            </div>
          )
        },
        {
