  ...
  return (
    <>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-32 pb-20 lg:py-0">
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center min-h-screen lg:min-h-0 lg:py-36">
              ...
              <div className="order-2 lg:order-1">
                ...
                {/* Primary Brand Stamp - animation-delay-200 */}
                <div className="opacity-0 animate-fade-in animation-delay-200 mb-6">
                ...
                {/* Launch Line - animation-delay-1100 */}
                ...
                <div className="opacity-0 animate-fade-in animation-delay-1200 mt-10 pt-8 border-t border-white/10">
                  <div className="flex flex-wrap items-center gap-6 sm:gap-8">
                    ...
                    {/* Same Day Access with tooltip - TIGHTENED LANGUAGE */}
                    <div className="relative group">
                      <div className="flex items-center gap-2 text-white/60 text-base cursor-help">
                        <Clock className="w-5 h-5 text-sfm-gold/80" aria-hidden="true" />
                        <span>Responsive Access</span>
                      </div>
                      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-white text-sfm-navy text-sm rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-20">
                ...
                <div className="bg-sfm-navy rounded-2xl p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      'Same-day or next-business-day visits for urgent concerns when available',
                      'Fewer than 200 patients per physician',
                      'The same physician every time, not a rotating team',
                      'Clear monthly pricing with multiple payment options. No visit fees or unexpected bills.',
                    ].map((item, i) => (
      ...
      {/* ================================================================
          ...
          - Added "Your exact rate is confirmed before enrollment"
          - Terminology: Membership-Based Primary Care (Direct Primary Care model)
          ================================================================ */}
      <section id="membership-plans" className="relative py-24 lg:py-32 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <ScrollReveal className="text-center mb-16">
            ...
            <p className="text-sfm-gold font-medium text-base mb-2">
              Founding members receive the lower end of each range.
            </p>
            <p className="text-sfm-navy/60 text-sm">
              Your exact rate is confirmed before enrollment.
            </p>
          </ScrollReveal>
      ...
      {/* ================================================================
          FINAL CTA
          - Updated copy: "Care is delivered through Atlas"
          ================================================================ */}
