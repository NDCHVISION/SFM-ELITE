...
import { ArrowRight, Clock, MessageCircle, Shield, Landmark, Users } from 'lucide-react'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Virtual Primary Care in Olympia | Sankofa Family Medicine',
    description: 'Premium virtual primary care for Olympia and Thurston County residents.',
    url: 'https://sankofafamilymedicine.com/locations/washington/olympia',
  },
  alternates: {
    canonical: 'https://sankofafamilymedicine.com/locations/washington/olympia',
  },
  other: {
    'geo.region': 'US-WA',
...
const structuredData = {
  ...
  name: 'Sankofa Family Medicine - Olympia',
  description: 'Virtual primary care serving Olympia and Thurston County including Lacey, Tumwater, and surrounding communities.',
  url: 'https://sankofafamilymedicine.com/locations/washington/olympia',
...
export default function OlympiaPage() {
  const neighborhoods = [
    'Downtown Olympia', 'West Olympia', 'South Capitol', 'Lacey',
    'Tumwater', 'Hawks Prairie', 'Yelm', 'Centralia', 'Shelton'
  ]

  const benefits = [
    {
      icon: Landmark,
      title: 'Capital Region Care',
      description: 'Healthcare designed for state employees and South Sound professionals.'
    },
    {
      icon: Clock,
      ...
      <section className="relative pt-32 pb-20 lg:pt-44 lg:pb-28 bg-gradient-to-b from-sfm-navy via-sfm-navy to-sfm-azure overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur rounded-full mb-6">
            <Landmark className="w-4 h-4 text-sfm-gold" />
            <span className="text-white/90 text-sm">State Capital</span>
          </div>
          
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-white mb-6">
            Virtual Primary Care<br />
            <span className="text-sfm-gold">for Olympia</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl md:text-4xl text-sfm-navy mb-4">
              Healthcare for the Capital Region
            </h2>
            <p className="text-sfm-text-muted max-w-2xl mx-auto">
              From downtown to Lacey, care designed for Thurston County living.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-sfm-text-muted">
              Virtual care for the capital region and beyond.
            </p>
          </div>
