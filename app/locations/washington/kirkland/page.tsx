...
import { ArrowRight, MapPin, Clock, MessageCircle, Shield, Waves, Building2 } from 'lucide-react'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Virtual Primary Care in Kirkland | Sankofa Family Medicine',
    description: 'Premium virtual primary care for Kirkland residents and professionals.',
    url: 'https://sankofafamilymedicine.com/locations/washington/kirkland',
  },
  alternates: {
    canonical: 'https://sankofafamilymedicine.com/locations/washington/kirkland',
  },
  other: {
    'geo.region': 'US-WA',
...
const structuredData = {
  ...
  name: 'Sankofa Family Medicine - Kirkland',
  description: 'Virtual primary care serving Kirkland and surrounding Lake Washington communities including Juanita, Totem Lake, and Houghton.',
  url: 'https://sankofafamilymedicine.com/locations/washington/kirkland',
...
export default function KirklandPage() {
  const neighborhoods = [
    'Downtown Kirkland', 'Juanita', 'Totem Lake', 'Houghton',
    'Moss Bay', 'Norkirk', 'Market', 'Finn Hill', 'Kingsgate'
  ]

  const benefits = [
    {
      icon: Building2,
      title: 'Tech-Friendly Care',
      description: 'Virtual appointments that integrate seamlessly with your workday. No commute required.'
    },
    {
      icon: Clock,
      ...
      <section className="relative py-20 lg:py-28 bg-gradient-to-b from-sfm-navy via-sfm-navy to-sfm-azure overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur rounded-full mb-6">
            <Waves className="w-4 h-4 text-sfm-gold" />
            <span className="text-white/90 text-sm">Lake Washington Waterfront</span>
          </div>
          
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-white mb-6">
            Virtual Primary Care<br />
            <span className="text-sfm-gold">for Kirkland</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-sfm-text-muted max-w-2xl mx-auto">
              From downtown to Juanita, care designed for how Kirkland lives and works.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-sfm-text-muted">
              Virtual care for every neighborhood along the waterfront and beyond.
            </p>
          </div>
