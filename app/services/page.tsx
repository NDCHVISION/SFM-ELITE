...
const tiers = [
  {
    ...
    features: [
      ...
      { text: 'Secure, non-urgent clinical messaging with the physician', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Limited after-hours secure messaging for time-sensitive, non-emergent clinical concerns', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Executive Concierge does not provide unrestricted or continuous physician availability; access is routed through established triage and care coordination workflows, and the Practice may decline requests that fall outside the scope of primary care or are not clinically appropriate.', included: true },
