...
// =============================================================================
// STRUCTURED DATA (JSON-LD) - SERVER
// - RegisterAction (waitlist) vs ReserveAction (can imply reservation/payment)
// - isAcceptingNewPatients: false (waitlist is not active clinical intake)
// - Keep claims factual and time-qualified ("planned")
// =============================================================================
