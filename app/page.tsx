...
export const metadata: Metadata = {
  ...
  other: {
    ...
    'llm-summary': 'Homepage for Sankofa Family Medicine, a virtual-first concierge medicine practice in Washington State. Patient enrollment, messaging, scheduling, and all clinical functions are handled through the Atlas patient portal. The website provides information about the practice but does not collect patient health information. Three membership tiers available: Continuity Concierge ($225/mo), Precision Concierge ($325/mo), Executive Concierge ($650/mo). Founded by Dr. Yaw Nkrumah, MD.',
    'llm-key-facts': 'Virtual Concierge Medicine | Washington State | $225-$725/month | Dr. Yaw Nkrumah MD | MUSC Graduate | Board Certified | Atlas Patient Portal | Sankofa means go back and retrieve',
    
    // Voice Search Optimization
    'voice-search-answer': 'Sankofa Family Medicine is a virtual concierge medicine practice serving Washington State. To reserve a Founders spot, visit their website and click Reserve a Founders Spot to access the secure enrollment portal. Membership starts at $225 per month.',
