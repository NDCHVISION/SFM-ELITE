      ...
      <section className="py-16 bg-white border-y border-gray-100" aria-labelledby="model-heading">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-sfm-navy/70 leading-relaxed">
            Sankofa Family Medicine is a virtual-only, physician-led, membership-based primary care practice, concierge in structure and precision-informed in approach, founded in 2025, operating from Spokane, Washington, and serving patients statewide in Washington through telehealth. {/* Compliance: Added founded date and location per temporal guardrail */}
