...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Become a patient through our secure patient portal for virtual-first concierge medicine in Washington State. Founding members receive exclusive pricing benefits.',
    url: 'https://sankofafamilymedicine.com/contact',
  ...
  twitter: {
    ...
    description: 'Become a patient through our secure patient portal for premium virtual primary care in Washington State.',
